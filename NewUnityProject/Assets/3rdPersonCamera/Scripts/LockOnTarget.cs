...
namespace ThirdPersonCamera
{
    ...
    public class LockOnTarget : MonoBehaviour
    {
        ...
        void Update()
        {
			if (Input.GetButton("LockTarget")) // right mouse click starts lock on mode
            {
			...
			//autofocus is On then HARDFOCUS
			if (hardFocus) // right mouse click starts lock on mode
			{
				if (followTarget == null)
				{
					// find a viable target
